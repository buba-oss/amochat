...
ChatUser user2 = ChatUser(id: '2', firstName: 'Buba');
ChatUser user3 = ChatUser(id: '3', lastName: 'Sanneh');
ChatUser user4 = ChatUser(id: '4',);
ChatUser user5 = ChatUser(id: '5', firstName: 'ala', lastName: 'fli');
ChatUser user6 =
ChatUser(id: '6', firstName: 'james', );
ChatUser user7 =
ChatUser(id: '7', lastName: 'james',  );
ChatUser user8 = ChatUser(
    id: '8', firstName: 'ous', lastName: 'baba',);
...
List<ChatMessage> allUsersSample = <ChatMessage>[
  ...
  ChatMessage(
    text: 'Test',
    user: user2,
    createdAt: DateTime(2022, 01, 30, 16, 45),
  ),
  ChatMessage(
    text: 'Test',
    user: user3,
...
List<ChatMessage> basicSample = <ChatMessage>[
  ChatMessage(
    text: 'google.com',
    user: user2,
    createdAt: DateTime(2022, 01, 31, 16, 45),
  ),
  ChatMessage(
    text: 'google.com',
    user: user2,
  ...
  ChatMessage(
    text: 'How you doing?',
    user: user8,
    createdAt: DateTime(2022, 01, 30, 16, 34),
  ),
  ChatMessage(
    text: 'Hey!',
    user: user,
    createdAt: DateTime(2022, 01, 30, 15, 50),
  ),
  ChatMessage(
    text: 'Hey!',
    user: user,
    createdAt: DateTime(2022, 01, 28, 15, 50),
  ),
  ChatMessage(
    text: 'Hey!',
    user: user,
